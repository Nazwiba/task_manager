    ...
    return SafeArea(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            upperHeader("Change Password", context, false, PrivacySecurity()),
            SizedBox(
              height: he * 0.042,
            ),
            Text(
              "Your password must be atleat 6 characters and should include a combination of numbers, letters and special characters",
              style: TextStyle(
